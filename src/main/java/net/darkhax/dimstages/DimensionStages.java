...
@Mod(modid = "dimstages", name = "Dimension Stages", version = "@VERSION@", dependencies = "required-after:bookshelf@[2.0.0.425,);required-after:gamestages@[1.0.18,);required-after:crafttweaker@[4.0.0.,)", acceptedMinecraftVersions = "[1.12,1.12.2)")
